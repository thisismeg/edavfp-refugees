...
``` {r fig.height = 15, warnings = FALSE}
library(ggalluvial)
...
# Demographic bar chart
afghan_stack <- ggplot(dem_afghan, aes(x = factor(Year), y = number / 1000)) +
  geom_bar(aes(fill = dem.age),stat = "identity", position = "stack") +
  facet_wrap(.~dem.sex) +
  xlab('Year') +
  ylab('Population of Persons of Concern (in thousands)') +
...
# Demographic bar chart
afghan_fill <- ggplot(dem_afghan, aes(x = factor(Year), y = number / 1000)) +
  geom_bar(aes(fill = dem.age),stat = "identity", position = "fill") +
  facet_wrap(.~dem.sex) +
  xlab('Year') +
...
afghan_variable <- ggplot(dem_afghan_sum, aes(x = center, y = number / binwidth, width = binwidth)) +
  geom_col(color = "lightblue", fill = "lightblue") +
...
grid.arrange(afghan_stack, afghan_fill, afghan_variable)
```
...
# Demographic bar chart
drc_stack <- ggplot(dem_congo, aes(x = factor(Year), y = number / 1000)) +
  geom_bar(aes(fill = dem.age),stat = "identity", position = "stack") +
  facet_wrap(.~dem.sex) +
  xlab('Year') +
  ylab('Population of Persons of Concern (in thousands)') +
...
drc_fill <- ggplot(dem_congo, aes(x = factor(Year), y = number / 1000)) +
  geom_bar(aes(fill = dem.age),stat = "identity", position = "fill") +
  facet_wrap(.~dem.sex) +
  xlab('Year') +
  ylab('Proportion of population') +
...
drc_variable <-ggplot(dem_congo_sum, aes(x = center, y = number / binwidth, width = binwidth)) +
  geom_col(color = "lightblue", fill = "lightblue") +
...
grid.arrange(drc_stack, drc_fill, drc_variable)
```
