...
Through exploring the demographic data for all 5 countries we picked, we realised that the data was extremely incomplete and the collection methods seemed to be lacking. For example, in the chart for Syria, a decrease in the number of persons of concern across all categories can be observed. However, from the other datasets, we know that that is not the case. A closer inspection reveals that the data was obtained through sampling at different local locations, and the locations at which this demographic sampling was done was not consistent across the years. The conflict worsening could possibly have resulted in less samples being taken, and hence a less accurate representation of the population numbers. 
...
Out of the 5 countries we looked at, South Sudan seemed to have the most complete demographic data, with about 260,000 persons out of 400,000 for which there was demographic data on. As such, it is the only demographic graph we are choosing to include in our executive summary.
